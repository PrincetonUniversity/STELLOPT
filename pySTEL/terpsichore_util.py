...
if __name__=="__main__":
	...
	if args.lplot_22:
		...
		fig=pyplot.figure(figsize=(1024*px,768*px))
		ax=fig.add_subplot(131)
		ax.plot(terp_data.am.T)
		ax=fig.add_subplot(132)
		ax.plot(terp_data.pvp.T)
		ax=fig.add_subplot(133)
		ax.plot(terp_data.pvpi.T)
		pyplot.show()
	if args.lplot_23:
		if args.terp_ext:
			file = arg.terp_ext
		...
		ax.set_xlabel('Norm. Toroidal Flux (s)'); ax.set_ylabel(rf'$\xi$')
		...
		ax.set_xlabel('Norm. Toroidal Flux (s)'); ax.set_ylabel(rf'$\eta$')
		pyplot.show()
