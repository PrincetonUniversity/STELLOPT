...
class VMEC(FourierRep):
	...
	def wout_to_indata(self):
		...
		indata.ai_aux_s = np.squeeze(self.ai_aux_s)
		indata.ai_aux_f = np.squeeze(self.ai_aux_f)
		indata.ac_aux_s = np.squeeze(self.ac_aux_s)
		indata.ac_aux_f = np.squeeze(self.ac_aux_f)
		indata.am_aux_s = np.squeeze(self.am_aux_s)
		indata.am_aux_f = np.squeeze(self.am_aux_f)
