      SUBROUTINE penta_imp(coeff_ext, Er_min, Er_max, js, i_append, 
     1               run_ident, pprof_char, B_Eprl_in)
      use penta_kind_mod
      use phys_const
      ...
      character(100), intent(inout) :: coeff_ext
      real(rknd), intent(inout) :: Er_min
      real(rknd), intent(inout) :: Er_max
      integer(iknd), intent(inout) :: js
      integer(iknd), intent(inout) :: i_append
      character(100), intent(inout) :: run_ident
      character(10), intent(inout) :: pprof_char
      real(rknd), intent(inout), OPTIONAL :: B_Eprl_in
