...
Before beginning please create an install branch.  To do this issue
the following commands from main directory:
...
Then submit a pull request through bitbucket.
