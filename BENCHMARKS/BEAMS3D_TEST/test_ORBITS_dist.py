...
print('==== Matrix ====')
varlist={}
varlist['dense_prof']=np.array([1.97E15, 1.54E15, 6.36E14, 6.90E14])
varlist['ipower_prof']=np.array([443, 346, 112, 122])
varlist['epower_prof']=np.array([678, 532, 271, 292])
varlist['j_prof']=np.array([-38.5, -47.5, -3.43, -6.06])
#print(data.keys())
