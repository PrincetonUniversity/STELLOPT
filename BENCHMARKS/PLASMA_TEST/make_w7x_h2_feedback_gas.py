...
NE0_init = 2.0E19 # can't be smaller than 10eV otherise clog gets negative
NE_edge_init = 5E18
...
ecrh_vec  = [1.50,4.00,4.00,4.00,4.00,0.00,0.00,0.00]
fuel_vec  = [2.00,2.00,5.00,5.00,5.00,5.00,0.00,0.00]
...
DT=1E-3
solver.run(Nr=101,dt=DT,tstart=0.0,tend=7.0,tolerance=1E-3,max_subiter=20,output_filename='w7x_h2_feedbackgas')
