...
!DEC$ IF DEFINED (REGCOIL)
      USE regcoil_variables, ONLY:  rms_K_target, nlambda, regcoil_nml
!DEC$ ENDIF      
!-----------------------------------------------------------------------
      ...
      IF (niter >= 0) THEN
         ...
         DO ii = 1, mnprod_x4_rcws
            ...
            IF (sigma(ii) < bigno) THEN
              ...
              ! The value of the results is in the rms_K_target variable
              vals(mtargets)    = rms_K_target
         ...
         IF (ANY(sigma < bigno)) THEN
            ...
            DO ii = 1, mnprod_x4_rcws
               IF (sigma(ii) < bigno) THEN
                  mtargets = mtargets + 1
                  IF (niter == -2) THEN
                     target_dex(mtargets)=jtarget_regcoil_rms_K
                  END IF
               END IF
            END DO
