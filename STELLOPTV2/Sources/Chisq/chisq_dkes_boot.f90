...
!     Date:          11/28/2025
!     Description:   Chisquared for the DKES bootstrap proxy.  The proxy
!                    is written as:
!                        D31 / ((2/3)*(1/nu*)-D33)
!-----------------------------------------------------------------------
      SUBROUTINE chisq_dkes_boot(target,sigma,niter,iflag)
!-----------------------------------------------------------------------
!     Libraries
!-----------------------------------------------------------------------
...
!DEC$ IF DEFINED (DKES_OPT)
               D31 = 0.5*(DKES_L31p(ik)+DKES_L31m(ik))
               D33 = 0.5*(DKES_L33p(ik)+DKES_L33m(ik))
...
!     END SUBROUTINE
!----------------------------------------------------------------------
      END SUBROUTINE chisq_dkes_boot
