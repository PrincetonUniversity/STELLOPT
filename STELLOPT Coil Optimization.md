...
!----------------------------------------------------------------------
!       Coil Spline Knots
!       COIL_TYPE is the coil model (see below)
...
!----- SADDLE COIL  6
  COIL_TYPE(  6) =   3
  RHO_COIL_KTS(  6,:) =    2.000000000000E-001
  THETA_COIL_KTS(  6,:) =    6.500000000000E-001   2.500000000000E-001
  ZETA_COIL_KTS(  6,:) =    1.570796330000E+000   6.000000000000E-001
!----- TF COIL  7
  COIL_TYPE(  7) =   4
  RHO_COIL_KTS(  7,:) =    1.000000000000E+000
  ZETA_COIL_KTS(  7,:) =    1.570796330000E+000
!----- HELICAL COIL  8
  COIL_TYPE(8) = 2
  RHO_COIL_KTS(  8,:) =    3.000000000000E-001   3.000000000000E-001   3.000000000000E-001   3.000000000000E-001   3.000000000000E-001   3.000000000000E-001   3.000000000000E-001   3.000000000000E-001
  THETA_COIL_KTS(  8,:) =    0.         0.44879895 0.8975979  1.34639685 1.7951958  2.24399475
 2.6927937  3.14159265
  ZETA_COIL_KTS(  8,:) =    0.         0.44879895 0.8975979  1.34639685 1.7951958  2.24399475
 2.6927937  3.14159265
!----------------------------------------------------------------------
...
## Coil Types
 1. Modular coils: The code assumes the last point is the first so
 it is not explicitly specified.
 2. Helical coils: The code assumes only one helical coil so the
 last point must lay at theta=phi=pi. (still in beta)
 3. Saddle coils: The first elements of RHO,THETA,ZETA define the center
 of the saddle coil. The second element of THETA and ZETA define the
 poloidal and toroidal extent of the coil.
 4. Toroidal field coil: RHO defines the minor radius of coil, while
 ZETA defines the toroidal position of the coil. Coils are centered on 
 the magnetic axis at ZETA.
