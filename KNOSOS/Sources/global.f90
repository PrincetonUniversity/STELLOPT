...
MODULE GLOBAL
  ...
  LOGICAL USE_B1,USE_B0pB1,QS_B0,QS_B0_1HEL,REMOVE_DIV,DELTA,FAST_AMB,ILAGRID
  INTEGER I0,J0,TRUNCATE_B,NER,NERR,MLAMBDA,MAL,NTURN
  ...
  LOGICAL FLUX_NU,PREC_TOP,NEW_DALPHA,STELL_ANTISYMMETRIC,DR_READ!,KROOK_OP
  LOGICAL, PARAMETER :: PLOT_XYZ=.FALSE.

  !Flux-surface constants
  INTEGER helN,helM,sgnhel
  REAL*8 rad_a,rad_R,eps,eps32,avB,avB2,etet
