...
!-----------------------------------------------------------------------
      IMPLICIT NONE
      INTEGER  ::    nr, nphi, nz, nte, nne, nti, nzeff, nn0,npot, dexionT, dexionD, dexionHe3
      INTEGER  ::    win_raxis, win_phiaxis, win_zaxis, win_B_R, win_B_PHI, win_B_Z,&
                     win_MODB, win_TE, win_NE, win_TI, win_ZEFF_ARR,win_N0_ARR,&
                     win_S_ARR, win_U_ARR,win_X_ARR,win_Y_ARR, win_POT_ARR, win_BR4D, win_BPHI4D, &
                     win_BZ4D, win_MODB4D, win_TE4D, win_NE4D, win_TI4D, win_ZEFF4D, win_N04D, &
      ...
      TYPE(EZspline3_r8) :: BR_spl, BPHI_spl, BZ_spl, MODB_spl, TE_spl, NE_spl, &
                            TI_spl, ZEFF_spl, N0_spl, S_spl, U_spl, X_spl, Y_spl,POT_spl
      TYPE(EZspline1_r8) :: TE_spl_s, NE_spl_s, TI_spl_S, ZEFF_spl_s, N0_spl_s, Vp_spl_s, POT_spl_s
