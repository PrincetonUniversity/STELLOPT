...
!-----------------------------------------------------------------------
      ...
      IF (PRESENT(IN_COMM)) THEN
         ...
         IF (ASSOCIATED(hr))       CALL mpidealloc(raxis,win_hr)
         IF (ASSOCIATED(hp))       CALL mpidealloc(raxis,win_hp)
         IF (ASSOCIATED(hz))       CALL mpidealloc(raxis,win_hz)
         IF (ASSOCIATED(hri))       CALL mpidealloc(raxis,win_hri)
         IF (ASSOCIATED(hpi))       CALL mpidealloc(raxis,win_hpi)
         IF (ASSOCIATED(hzi))       CALL mpidealloc(raxis,win_hzi)
