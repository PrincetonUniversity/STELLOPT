...
!-----------------------------------------------------------------------
      ...
      IF (EZspline_allocated(VTOR_spl))   CALL EZspline_free(VTOR_spl,ier)
      ...
      IF (PRESENT(IN_COMM)) THEN
         ...
         IF (ASSOCIATED(VTOR_ARR))  CALL mpidealloc(VTOR_ARR,win_VTOR_ARR)
         ...
         IF (ASSOCIATED(VTOR4D))    CALL mpidealloc(VTOR4D,win_VTOR4D)
      ...
      ELSE
         ...
         IF (ASSOCIATED(VTOR_ARR))  DEALLOCATE(VTOR_ARR)
         ...
         IF (ASSOCIATED(VTOR4D))    DEALLOCATE(VTOR4D)
