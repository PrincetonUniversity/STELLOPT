...
!-----------------------------------------------------------------------
      ...
      IF (EZspline_allocated(N0_spl))   CALL EZspline_free(N0_spl,ier)
      ...
      IF (PRESENT(IN_COMM)) THEN
         ...
         IF (ASSOCIATED(N0_ARR)) CALL mpidealloc(N0_ARR,win_N0_ARR)
         ...
         IF (ASSOCIATED(N04D))     CALL mpidealloc(N04D,win_N04D)
      ...
      ELSE
         ...
         IF (ASSOCIATED(N0_ARR)) DEALLOCATE(N0_ARR)
         ...
         IF (ASSOCIATED(N04D))     DEALLOCATE(N04D)
