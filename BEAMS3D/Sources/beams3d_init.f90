...
!-----------------------------------------------------------------------
      ...
      IF (lfidasim) THEN
         ...
         e_h = energy_fida(2) - energy_fida(1) !(energy_fida(nenergy_fida) - energy_fida(1)) / (nenergy_fida)
         pi_h = pitch_fida(2) - pitch_fida(1)!(pitch_fida(npitch_fida) - pitch_fida(1)) / (npitch_fida)
