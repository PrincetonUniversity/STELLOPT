...
!-----------------------------------------------------------------------
   ...
   IF ((lvmec .or. leqdsk .or. lhint .or. lfieldlines .or. lrestart_grid) .and. .not.lvac) THEN
      ...
      IF (nte>0) THEN
         ...
         IF (lverb) WRITE(6,'(A,F9.5,A,F9.5,A,I4,A,F8.2)') '   Te   = [', &
      ...
      IF (nti>0) THEN
         ...
         IF (lverb) WRITE(6,'(A,F9.5,A,F9.5,A,I4,A,F8.2)') '   Ti   = [', &
      ...
      IF (nne>0) THEN
         ...
         IF (lverb) WRITE(6,'(A,F9.5,A,F9.5,A,I4,A,F8.2)') '   Ne   = [', &
      ...
      DO i = 1, NION
         ...
         IF (lverb .and. ANY(NI_AUX_F(i,:)>0)) WRITE(6,'(A,I1,A,F9.5,A,F9.5,A,I3,A,I2,A,F8.2)') '   Ni(',i,')= [', &
      ...
      IF (nzeff>0) THEN
         ...
         IF (lverb) WRITE(6,'(A,F9.5,A,F9.5,A,I4,A,F8.2)') '   Zeff = [', &
      ...
      IF (npot>0) THEN
         ...
         IF (lverb) WRITE(6,'(A,F9.5,A,F9.5,A,I4,A,F8.2)') '   V    = [', &
