...
SUBROUTINE beams3d_follow
    ...
    IF (myid_sharmem == master) THEN
       ...
       CALL MPI_REDUCE(MPI_IN_PLACE, end_triangle,      nparticles,          MPI_INTEGER, MPI_MAX, master, MPI_COMM_SHARMEM, ierr_mpi)
    ...
    ELSE
       ...
       CALL MPI_REDUCE(end_triangle, end_triangle,      nparticles,          MPI_INTEGER, MPI_MAX, master, MPI_COMM_SHARMEM, ierr_mpi)
    ...
    IF (myid_sharmem == master) THEN
       ...
       CALL MPI_ALLREDUCE(MPI_IN_PLACE, end_triangle,      nparticles,          MPI_INTEGER, MPI_MAX, MPI_COMM_LOCAL, ierr_mpi)
