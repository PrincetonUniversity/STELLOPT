      subroutine r8evtricub(xget,yget,zget,x,nx,y,ny,z,nz,
     >                   ilinx,iliny,ilinz,
...
! idecl:  explicitize implicit REAL declarations:
      REAL*8 z36th,z216th,xp,xpi,xp2,xpi2,cx,cxi,hx2,yp,ypi,yp2
      REAL*8 ypi2,cy,cyi,hy2,zp,zpi,zp2,zpi2,cz,czi,hz2,cxd,cxdi
      REAL*8 cyd,cydi,czd,czdi
!============
...
C
               ...
               czd=3.0_r8*zp2-1.0_r8
               czdi=-3.0_r8*zpi2+1.0_r8
C
               sum=hzi(v)*(
     >            -(
     >              xpi*(ypi*fin(0,i,j,k)  +yp*fin(0,i,j+1,k))+
...
C
      subroutine r8fvtricubx(ict,ivec,ivecd,
     >   fval,ii,jj,kk,xparam,yparam,zparam,
     >   hx,hxi,hy,hyi,hz,hzi,
     >   fin,inf2,inf3,nz)
C
...
!============
! idecl:  explicitize implicit REAL declarations:
      REAL*8 z36th,z216th,yp,ypi,yp2,ypi2,cy,cyi,hy2,zp,zpi,zp2
      REAL*8 zpi2,cz,czi,hz2,xp,xpi,xp2,xpi2,cx,cxi,hx2,cxd,cxdi
      REAL*8 cyd,cydi,czd,czdi
!============
      integer ict(10)                   ! requested output control
      integer ivec                      ! vector length
