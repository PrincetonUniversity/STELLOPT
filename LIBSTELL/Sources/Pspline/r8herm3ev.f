      subroutine r8herm3ev(xget,yget,zget,x,nx,y,ny,z,nz,
     >                   ilinx,iliny,ilinz,
...
c
      subroutine r8herm3xyz(xget,yget,zget,x,nx,y,ny,z,nz,
     >   ilinx,iliny,ilinz,
...
c
      ...
      REAL*8 x(nx),y(ny),z(nz)            ! indep. coords. (ascending order)
c
...
C
      subroutine r8herm3fcn(ict,ivec,ivecd,
...
! idecl:  explicitize implicit REAL declarations:
      ...
      REAL*8 aybar,by,bybar,zp,zpi,zp2,zpi2,az,azbar,bz,bzbar,axp
      REAL*8 axbarp,bxp,bxbarp,ayp,aybarp,byp,bybarp,azp,azbarp,bzp
      REAL*8 bzbarp
!============
...
C
      REAL*8 fin(0:7,inf2,inf3,nz)        ! interpolant data (cf "herm3ev")
C
...
C
         azp=6.0_r8*zp*zpi
         azbarp=-azp
         bzp=zp*(3.0_r8*zp-2.0_r8)
         bzbarp=zpi*(3.0_r8*zpi-2.0_r8)
C
...
C
      subroutine r8herm3fcnx(ict,ivec,ivecd,
     >   fval,ii,jj,kk,xparam,yparam,zparam,
     >   hx,hxi,hy,hyi,hz,hzi,
     >   fin,inf2,inf3,nz)
C
...
!============
! idecl:  explicitize implicit REAL declarations:
      REAL*8 yp,ypi,yp2,ypi2,ay,aybar,by,bybar,zp,zpi,zp2,zpi2,az
      REAL*8 azbar,bz,bzbar,ayp,aybarp,byp,bybarp,azp,azbarp,bzp
      REAL*8 bzbarp,xp,xpi,xp2,xpi2,ax,axbar,bx,bxbar,axp,axbarp
      REAL*8 bxp,bxbarp
!============
      integer ict(8)                    ! requested output control
      integer ivec                      ! vector length
