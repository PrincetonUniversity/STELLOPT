...
c
 ...
 1012       format(' %tcspeval:  yget=',1pe15.8,' beyond range ',
     >         1pe15.8,' to ',1pe15.8,' (fixup applied)')
      ...
      if((zget.lt.z(1)).or.(zget.gt.z(nz))) then
         zztol=4.0E-7_r8*max(abs(z(1)),abs(z(nz)))
 ...
 1003       format(' ?tcspeval:  zget=',1pe11.4,' out of range ',
     >         1pe11.4,' to ',1pe11.4)
            ...
            if((zget.lt.z(1)-0.5_r8*zztol).or.
     >         (zget.gt.z(nz)+0.5_r8*zztol))
...
c  evaluate df/dy
            ...
            do v=1,ivec
               ...
               p1=
     >     f(1,2,1,i,j,k)+
     >         dy*(2.0_r8*f(1,3,1,i,j,k)+dy*3.0_r8*f(1,4,1,i,j,k))
     >+dx*(f(2,2,1,i,j,k)+
     >         dy*(2.0_r8*f(2,3,1,i,j,k)+dy*3.0_r8*f(2,4,1,i,j,k))
     >+dx*(f(3,2,1,i,j,k)+
     >         dy*(2.0_r8*f(3,3,1,i,j,k)+dy*3.0_r8*f(3,4,1,i,j,k))
     >+dx*(f(4,2,1,i,j,k)+
     >         dy*(2.0_r8*f(4,3,1,i,j,k)+dy*3.0_r8*f(4,4,1,i,j,k))
     >         )))
               p2=
     >     f(1,2,2,i,j,k)+
     >         dy*(2.0_r8*f(1,3,2,i,j,k)+dy*3.0_r8*f(1,4,2,i,j,k))
     >+dx*(f(2,2,2,i,j,k)+
     >         dy*(2.0_r8*f(2,3,2,i,j,k)+dy*3.0_r8*f(2,4,2,i,j,k))
     >+dx*(f(3,2,2,i,j,k)+
     >         dy*(2.0_r8*f(3,3,2,i,j,k)+dy*3.0_r8*f(3,4,2,i,j,k))
     >+dx*(f(4,2,2,i,j,k)+
     >         dy*(2.0_r8*f(4,3,2,i,j,k)+dy*3.0_r8*f(4,4,2,i,j,k))
     >         )))
               p3=
     >     f(1,2,3,i,j,k)+
     >         dy*(2.0_r8*f(1,3,3,i,j,k)+dy*3.0_r8*f(1,4,3,i,j,k))
     >+dx*(f(2,2,3,i,j,k)+
     >         dy*(2.0_r8*f(2,3,3,i,j,k)+dy*3.0_r8*f(2,4,3,i,j,k))
     >+dx*(f(3,2,3,i,j,k)+
     >         dy*(2.0_r8*f(3,3,3,i,j,k)+dy*3.0_r8*f(3,4,3,i,j,k))
     >+dx*(f(4,2,3,i,j,k)+
     >         dy*(2.0_r8*f(4,3,3,i,j,k)+dy*3.0_r8*f(4,4,3,i,j,k))
     >         )))
               p4=
     >     f(1,2,4,i,j,k)+
     >         dy*(2.0_r8*f(1,3,4,i,j,k)+dy*3.0_r8*f(1,4,4,i,j,k))
     >+dx*(f(2,2,4,i,j,k)+
     >         dy*(2.0_r8*f(2,3,4,i,j,k)+dy*3.0_r8*f(2,4,4,i,j,k))
     >+dx*(f(3,2,4,i,j,k)+
     >         dy*(2.0_r8*f(3,3,4,i,j,k)+dy*3.0_r8*f(3,4,4,i,j,k))
     >+dx*(f(4,2,4,i,j,k)+
     >         dy*(2.0_r8*f(4,3,4,i,j,k)+dy*3.0_r8*f(4,4,4,i,j,k))
     >         )))
               fval(v,iaval)=p1+dz*(p2+dz*(p3+dz*p4))
            enddo
         endif
...
c  evaluate df/dz
     ...
     >            dy*f(4,4,4,i,j,k)))
     >         )))
               fval(v,iaval)=p2+dz*(2.0_r8*p3+dz*3.0_r8*p4)
            enddo
         endif
c
...
c  evaluate d2f/dy2
            ...
            do v=1,ivec
               ...
               dz=dzv(v)
               p1=
     >            2.0_r8*f(1,3,1,i,j,k)+6.0_r8*dy*f(1,4,1,i,j,k)
     >            +dx*(2.0_r8*f(2,3,1,i,j,k)+6.0_r8*dy*f(2,4,1,i,j,k)
     >            +dx*(2.0_r8*f(3,3,1,i,j,k)+6.0_r8*dy*f(3,4,1,i,j,k)
     >            +dx*(2.0_r8*f(4,3,1,i,j,k)+6.0_r8*dy*f(4,4,1,i,j,k))))
               p2=
     >            2.0_r8*f(1,3,2,i,j,k)+6.0_r8*dy*f(1,4,2,i,j,k)
     >            +dx*(2.0_r8*f(2,3,2,i,j,k)+6.0_r8*dy*f(2,4,2,i,j,k)
     >            +dx*(2.0_r8*f(3,3,2,i,j,k)+6.0_r8*dy*f(3,4,2,i,j,k)
     >            +dx*(2.0_r8*f(4,3,2,i,j,k)+6.0_r8*dy*f(4,4,2,i,j,k))))
               p3=
     >            2.0_r8*f(1,3,3,i,j,k)+6.0_r8*dy*f(1,4,3,i,j,k)
     >            +dx*(2.0_r8*f(2,3,3,i,j,k)+6.0_r8*dy*f(2,4,3,i,j,k)
     >            +dx*(2.0_r8*f(3,3,3,i,j,k)+6.0_r8*dy*f(3,4,3,i,j,k)
     >            +dx*(2.0_r8*f(4,3,3,i,j,k)+6.0_r8*dy*f(4,4,3,i,j,k))))
               p4=
     >            2.0_r8*f(1,3,4,i,j,k)+6.0_r8*dy*f(1,4,4,i,j,k)
     >            +dx*(2.0_r8*f(2,3,4,i,j,k)+6.0_r8*dy*f(2,4,4,i,j,k)
     >            +dx*(2.0_r8*f(3,3,4,i,j,k)+6.0_r8*dy*f(3,4,4,i,j,k)
     >            +dx*(2.0_r8*f(4,3,4,i,j,k)+6.0_r8*dy*f(4,4,4,i,j,k))))
               fval(v,iaval)=p1+dz*(p2+dz*(p3+dz*p4))
            enddo
         endif
c
...
c  evaluate df2/dz2
     ...
     >            dy*f(4,4,4,i,j,k)))
     >            )))
               fval(v,iaval)=2.0_r8*p3+6.0_r8*dz*p4
            enddo
         endif
c
...
c  evaluate d4f/dx2dy2
            ...
            do v=1,ivec
               ...
               dz=dzv(v)
               p1=
     >         4.0_r8*f(3,3,1,i,j,k)+12.0_r8*dy*f(3,4,1,i,j,k)
     >         +dx*(12.0_r8*f(4,3,1,i,j,k)+36.0_r8*dy*f(4,4,1,i,j,k))
               p2=
     >         4.0_r8*f(3,3,2,i,j,k)+12.0_r8*dy*f(3,4,2,i,j,k)
     >         +dx*(12.0_r8*f(4,3,2,i,j,k)+36.0_r8*dy*f(4,4,2,i,j,k))
               p3=
     >         4.0_r8*f(3,3,3,i,j,k)+12.0_r8*dy*f(3,4,3,i,j,k)
     >         +dx*(12.0_r8*f(4,3,3,i,j,k)+36.0_r8*dy*f(4,4,3,i,j,k))
               p4=
     >         4.0_r8*f(3,3,4,i,j,k)+12.0_r8*dy*f(3,4,4,i,j,k)
     >         +dx*(12.0_r8*f(4,3,4,i,j,k)+36.0_r8*dy*f(4,4,4,i,j,k))
               fval(v,iaval)=p1+dz*(p2+dz*(p3+dz*p4))
            enddo
         endif
c
...
C                               ! fxxy
            ...
            do v=1,ivec
               ...
               dz=dzv(v)
               p1= 2.0_r8*
     >            (f(3,2,1,i,j,k)+2.0_r8*dy*(f(3,3,1,i,j,k)+
     >            1.5_r8*dy*f(3,4,1,i,j,k)))
     >          +6.0_r8*dx*
     >            (f(4,2,1,i,j,k)+2.0_r8*dy*(f(4,3,1,i,j,k)+
     >            1.5_r8*dy*f(4,4,1,i,j,k)))
               p2= 2.0_r8*
     >            (f(3,2,2,i,j,k)+2.0_r8*dy*(f(3,3,2,i,j,k)+
     >            1.5_r8*dy*f(3,4,2,i,j,k)))
     >          +6.0_r8*dx*
     >            (f(4,2,2,i,j,k)+2.0_r8*dy*(f(4,3,2,i,j,k)+
     >            1.5_r8*dy*f(4,4,2,i,j,k)))
               p3= 2.0_r8*
     >            (f(3,2,3,i,j,k)+2.0_r8*dy*(f(3,3,3,i,j,k)+
     >            1.5_r8*dy*f(3,4,3,i,j,k)))
     >          +6.0_r8*dx*
     >            (f(4,2,3,i,j,k)+2.0_r8*dy*(f(4,3,3,i,j,k)+
     >            1.5_r8*dy*f(4,4,3,i,j,k)))
               p4= 2.0_r8*
     >            (f(3,2,4,i,j,k)+2.0_r8*dy*(f(3,3,4,i,j,k)+
     >            1.5_r8*dy*f(3,4,4,i,j,k)))
     >          +6.0_r8*dx*
     >            (f(4,2,4,i,j,k)+2.0_r8*dy*(f(4,3,4,i,j,k)+
     >            1.5_r8*dy*f(4,4,4,i,j,k)))
C
               fval(v,iaval)=p1+dz*(p2+dz*(p3+dz*p4))
            enddo
         endif
...
C
               p1=
     >            2.0_r8*f(2,3,1,i,j,k)+6.0_r8*dy*f(2,4,1,i,j,k)
     >              +2.0_r8*dx*(
     >            2.0_r8*f(3,3,1,i,j,k)+6.0_r8*dy*f(3,4,1,i,j,k)
     >              +1.5_r8*dx*(
     >            2.0_r8*f(4,3,1,i,j,k)+6.0_r8*dy*f(4,4,1,i,j,k)))
               p2=
     >            2.0_r8*f(2,3,2,i,j,k)+6.0_r8*dy*f(2,4,2,i,j,k)
     >              +2.0_r8*dx*(
     >            2.0_r8*f(3,3,2,i,j,k)+6.0_r8*dy*f(3,4,2,i,j,k)
     >              +1.5_r8*dx*(
     >            2.0_r8*f(4,3,2,i,j,k)+6.0_r8*dy*f(4,4,2,i,j,k)))
               p3=
     >            2.0_r8*f(2,3,3,i,j,k)+6.0_r8*dy*f(2,4,3,i,j,k)
     >              +2.0_r8*dx*(
     >            2.0_r8*f(3,3,3,i,j,k)+6.0_r8*dy*f(3,4,3,i,j,k)
     >              +1.5_r8*dx*(
     >            2.0_r8*f(4,3,3,i,j,k)+6.0_r8*dy*f(4,4,3,i,j,k)))
               p4=
     >            2.0_r8*f(2,3,4,i,j,k)+6.0_r8*dy*f(2,4,4,i,j,k)
     >              +2.0_r8*dx*(
     >            2.0_r8*f(3,3,4,i,j,k)+6.0_r8*dy*f(3,4,4,i,j,k)
     >              +1.5_r8*dx*(
     >            2.0_r8*f(4,3,4,i,j,k)+6.0_r8*dy*f(4,4,4,i,j,k)))
               fval(v,iaval)=p1+dz*(p2+dz*(p3+dz*p4))
            enddo
         endif
C
...
C
               p1=
     >            6.0_r8*(f(1,4,1,i,j,k)
     >            +dx*(f(2,4,1,i,j,k)
     >            +dx*(f(3,4,1,i,j,k)
     >            +dx*f(4,4,1,i,j,k))))
               p2=
     >            6.0_r8*(f(1,4,2,i,j,k)
     >            +dx*(f(2,4,2,i,j,k)
     >            +dx*(f(3,4,2,i,j,k)
     >            +dx*f(4,4,2,i,j,k))))
               p3=
     >            6.0_r8*(f(1,4,3,i,j,k)
     >            +dx*(f(2,4,3,i,j,k)
     >            +dx*(f(3,4,3,i,j,k)
     >            +dx*f(4,4,3,i,j,k))))
               p4=
     >            6.0_r8*(f(1,4,4,i,j,k)
     >            +dx*(f(2,4,4,i,j,k)
     >            +dx*(f(3,4,4,i,j,k)
     >            +dx*f(4,4,4,i,j,k))))
               fval(v,iaval)=p1+dz*(p2+dz*(p3+dz*p4))
...
C
     ...
     >            4.0_r8*f(3,3,1,i,j,k)+12.0_r8*dy*f(3,4,1,i,j,k)
     >              +12.0_r8*dx*(
     >            f(4,3,1,i,j,k)+3.0_r8*dy*f(4,4,1,i,j,k))
               p2=
     >            4.0_r8*f(3,3,2,i,j,k)+12.0_r8*dy*f(3,4,2,i,j,k)
     >              +12.0_r8*dx*(
     >            f(4,3,2,i,j,k)+3.0_r8*dy*f(4,4,2,i,j,k))
               p3=
     >            4.0_r8*f(3,3,3,i,j,k)+12.0_r8*dy*f(3,4,3,i,j,k)
     >              +12.0_r8*dx*(
     >            f(4,3,3,i,j,k)+3.0_r8*dy*f(4,4,3,i,j,k))
               p4=
     >            4.0_r8*f(3,3,4,i,j,k)+12.0_r8*dy*f(3,4,4,i,j,k)
     >              +12.0_r8*dx*(
     >            f(4,3,4,i,j,k)+3.0_r8*dy*f(4,4,4,i,j,k))
C
               fval(v,iaval)=p1+dz*(p2+dz*(p3+dz*p4))
            enddo
         endif
...
C
               p1=
     >            6.0_r8*(f(2,4,1,i,j,k)
     >              +2.0_r8*dx*(f(3,4,1,i,j,k)
     >              +1.5_r8*dx*f(4,4,1,i,j,k)))
               p2=
     >            6.0_r8*(f(2,4,2,i,j,k)
     >              +2.0_r8*dx*(f(3,4,2,i,j,k)
     >              +1.5_r8*dx*f(4,4,2,i,j,k)))
               p3=
     >            6.0_r8*(f(2,4,3,i,j,k)
     >              +2.0_r8*dx*(f(3,4,3,i,j,k)
     >              +1.5_r8*dx*f(4,4,3,i,j,k)))
               p4=
     >            6.0_r8*(f(2,4,4,i,j,k)
     >              +2.0_r8*dx*(f(3,4,4,i,j,k)
     >              +1.5_r8*dx*f(4,4,4,i,j,k)))
C
               fval(v,iaval)=p1+dz*(p2+dz*(p3+dz*p4))
            enddo
         endif
...
C                               ! fxxyyy
            ...
            do v=1,ivec
               ...
               dz=dzv(v)
C
               p1=12.0_r8*(f(3,4,1,i,j,k)+3.0_r8*dx*f(4,4,1,i,j,k))
               p2=12.0_r8*(f(3,4,2,i,j,k)+3.0_r8*dx*f(4,4,2,i,j,k))
               p3=12.0_r8*(f(3,4,3,i,j,k)+3.0_r8*dx*f(4,4,3,i,j,k))
               p4=12.0_r8*(f(3,4,4,i,j,k)+3.0_r8*dx*f(4,4,4,i,j,k))
C
               fval(v,iaval)=p1+dz*(p2+dz*(p3+dz*p4))
            enddo
         endif
...
C                               ! fxxxyyy
            ...
            do v=1,ivec
               ...
               dz=dzv(v)
C
               p1=36.0_r8*f(4,4,1,i,j,k)
               p2=36.0_r8*f(4,4,2,i,j,k)
               p3=36.0_r8*f(4,4,3,i,j,k)
               p4=36.0_r8*f(4,4,4,i,j,k)
C
               fval(v,iaval)=p1+dz*(p2+dz*(p3+dz*p4))
            enddo
         endif
