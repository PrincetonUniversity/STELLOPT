      subroutine r8mkspl3pb(fun,x,nx,th,nth,ph,nph,fspl,nf4,nf5,
...
C
      REAL*8 fspl(4,4,4,nf4,nf5,nph)      ! function data / spline coeff array
...
C
      ...
      enddo
C
      call r8tpsplinb(x,nx,th,nth,ph,nph,fspl,nf4,nf5,
     >   ibcxmin,bcxmin,ibcxmax,bcxmax,nb1,
     >   wk,inwk,ilinx,ilinth,ilinph,ier)
C
      return
