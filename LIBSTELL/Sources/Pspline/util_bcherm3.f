      subroutine util_bcherm3(fherm,idimx1,idimx2,idimx3,
...
C... insert BCs as needed for Hermite interpolation setup
      ...
      real :: zbcx1a(idimx2,idimx3) ! x1(1) BC data
      real :: zbcx1b(idimx2,idimx3) ! x1(idimx1) BC data

      integer :: jbcx2a,jbcx2b  ! x2 BC controls
      real :: zbcx2a(idimx1,idimx3) ! x2(1) BC data
      real :: zbcx2b(idimx1,idimx3) ! x2(idimx2) BC data

      integer :: jbcx3a,jbcx3b  ! x3 BC controls
      real :: zbcx3a(idimx2,idimx3) ! x3(1) BC data
      real :: zbcx3b(idimx2,idimx3) ! x3(idimx3) BC data

      real :: x1(idimx1),x2(idimx2),x3(idimx3)
