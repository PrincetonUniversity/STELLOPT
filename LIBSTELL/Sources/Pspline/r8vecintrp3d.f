      subroutine r8vecintrp3d(ict,ivec,xvec,yvec,zvec,ivd,fval,
...
c
      ...
      REAL*8 fspl(icoeff,ixdim,iydim,izdim)     ! hybrid spline coefficients
c
...
c
      call r8fvintrp3d(ict,ivec,ivd,fval,ix,iy,iz,dxn,dyn,dzn,
