      subroutine r8evintrp3d(xget,yget,zget,x,nx,y,ny,z,nz,jspline,
...
C
      REAL*8 f(icoeff,ixdim,iydim,izdim)  ! function data
C
...
C
      call r8herm3xyz(xget,yget,zget,x,nx,y,ny,z,nz,0,0,0,
     >     i,j,k,xparam,yparam,zparam,hx,hxi,hy,hyi,hz,hzi,ier)
      if(ier.ne.0) return
c
      call r8fvintrp3d(ict,1,1,
...
C   NO ERROR CHECKING
C
      subroutine r8fvintrp3d(ict,ivec,ivecd,
...
C
      ...
      REAL*8 fin(icoeff,ixdim,iydim,izdim)  ! data on which to interpolate...
C
...
C
      REAL*8 :: xp,yp,hhx,hhy,hhxi,hhyi,fac1,fac2(2)
      REAL*8 :: h,hi,hhi,h2(2),h2i(2)
      REAL*8 :: f22(2,2),f22b(2,2),f2222(2,2,2,2),ans22(2,2),ans1,ans2
      REAL*8 :: f422(4,2,2),f422b(4,2,2)
C
      REAL*8, parameter :: ONE = 1.0_r8
      REAL*8, parameter :: sixth = 0.166666666666666667_r8
      REAL*8, parameter :: z36th = sixth*sixth
C
C---------------
C
      zonrank=0
...
C
      if(cubrank.eq.3) then
         if(splin_flag) then
            !  bicubic spline
            call r8fvtricub(ict,ivec,ivecd,
     >           fval,ii,jj,kk,xparam,yparam,zparam,
     >           hx,hxi,hy,hyi,hz,hzi,
     >           fin,ixdim,iydim,izdim)
            ...
            do i=1,inum
               if(maxval(iderivs(1:3,i)).le.1) then
                  ...
                  call r8herm3fcn(ict8,ivec,ivecd,
...
C----------------------
          ...
          REAL*8 :: xpi,xp2,xpi2,cx,cxi,hx2,cxd,cxdi
C
C----------------------
...
C----------------------
          ...
          REAL*8 xpi,xp2,xpi2,cx,cxi,hx2,cxd,cxdi
          REAL*8 ypi,yp2,ypi2,cy,cyi,hy2,cyd,cydi
...
C----------------------
          ...
          REAL*8 :: ypi,yp2,ypi2,ay,aybar,by,bybar
          REAL*8 :: ayp,aybarp,byp,bybarp
