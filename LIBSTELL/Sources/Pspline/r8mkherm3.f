      subroutine r8mkherm3(fun,x,nx,y,ny,z,nz,fherm)
C
...
! idecl:  explicitize implicit REAL declarations:
      REAL*8 fun,dfdx,dfdy,dfdz,d2fdxdy,d2fdxdz,d2fdydz,d3fdxyz
!============
      external fun                      ! passed real function(x,y,z)
      REAL*8 x(nx)                        ! x coordinate array  (1st dim)
      REAL*8 y(ny)                        ! y coordinate array  (2nd dim)
      REAL*8 z(nz)                        ! z coordinate array  (3rd dim)
C
...
C  output:
C
      REAL*8 fherm(0:7,nx,ny,nz)          ! function data & derivatives
C
