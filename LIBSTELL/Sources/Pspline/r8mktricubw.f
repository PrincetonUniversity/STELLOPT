...
C
     ...
     >               fwk,nx,ny,nz)
                  ...
                  fin(2,ix,iy,iz)=2.0_r8*fwk(3,1,1,ix,iy,iz)
                  fin(3,ix,iy,iz)=2.0_r8*fwk(1,3,1,ix,iy,iz)
                  fin(4,ix,iy,iz)=2.0_r8*fwk(1,1,3,ix,iy,iz)
                  fin(5,ix,iy,iz)=4.0_r8*fwk(3,3,1,ix,iy,iz)
                  fin(6,ix,iy,iz)=4.0_r8*fwk(3,1,3,ix,iy,iz)
                  fin(7,ix,iy,iz)=4.0_r8*fwk(1,3,3,ix,iy,iz)
                  fin(8,ix,iy,iz)=8.0_r8*fwk(3,3,3,ix,iy,iz)
               endif
C
            enddo
         enddo
