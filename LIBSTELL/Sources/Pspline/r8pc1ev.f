      subroutine r8pc1ev(xget,x,nx,ilinx,f,ict,fval,ier)
C
...
C
      ...
      if(ier.ne.0) return
c
      call r8pc1fcn(ict,1,1,fval,i,xparam,hx,hxi,f,nx)
C
      return
      end
C---------------------------------------------------------------------
...
C
      subroutine r8pc1fcn(ict,ivec,ivecd,
