      subroutine r8vectricub(ict,ivec,xvec,yvec,zvec,ivd,fval,
...
c input:
      ...
      REAL*8 fspl(8,inf4,inf5,nz)         ! (compact) spline coefficients
c
c output:
...
c
      call r8fvtricub(ict,ivec,ivd,fval,ix,iy,iz,dxn,dyn,dzn,
