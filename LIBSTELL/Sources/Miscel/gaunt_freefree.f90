...
!-----------------------------------------------------------------------
      REAL(rprec), PARAMETER, DIMENSION(41) :: table_log_g2 = (/-4.00,&
      ...
      REAL(rprec), PARAMETER, DIMENSION(41) :: table_gff0 = (/1.113888,&
      ...
      REAL(rprec), PARAMETER, DIMENSION(41) :: table_s1 = (/1.3480E-2,&
      ...
      REAL(rprec), PARAMETER, DIMENSION(41) :: table_s2 = (/1.0471E-2,&
      ...
      REAL(rprec), PARAMETER, DIMENSION(41) :: table_s3 = (/-1.8550E-3,&
