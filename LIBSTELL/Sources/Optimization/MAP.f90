      SUBROUTINE MAP(obj, n, m, XCmin, XCmax, NP, iwrite, ndiv)
!.......................................................................
!
...
!DEC$ ENDIF
      ...
      REAL(rprec), DIMENSION(n), INTENT(in) :: XCmin, XCmax
      EXTERNAL  obj
...
!DEC$ ENDIF
      ...
      DO i = 1, num_search
         ...
         DO WHILE(itemp > 0)
            ...
            itemp = itemp / ndiv
         END DO
         !IF (myid == master) PRINT *,'   ',i,bin_step
         grid(i,1:n) = XCmin(1:n) + dx(1:n) * bin_step(1:n)
      END DO
      !DO i = 1, num_search
      !   IF (myid == master) PRINT *,'   ',i,grid(i,1:n)
      !END DO
