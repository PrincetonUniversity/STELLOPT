...
!-----------------------------------------------------------------------
      ...
      LOGICAL, DIMENSION(ndatafmax)  ::  lam_s_opt, lam_f_opt,&
                                ...
                                lzeff_f_opt, lemis_xics_f_opt, lemis_xmcts_f_opt, &
      ...
      REAL(rprec), DIMENSION(ndatafmax) ::  ne_aux_s, te_aux_s, &
                                            ...
                                            bootj_aux_s, sfincs_s, emis_xics_s, emis_xmcts_s
      ...
      REAL(rprec), DIMENSION(ndatafmax) ::  ne_aux_f, te_aux_f, &
                                            ...
                                            bootj_aux_f, emis_xics_f, emis_xmcts_f 
      ...
      REAL(rprec), DIMENSION(ndatafmax) ::  am_f_min, ac_f_min, &
                                            ...
                                            ne_f_min, te_f_min, &
                                            ti_f_min, th_f_min, &
                                            zeff_f_min, emis_xics_f_min, emis_xmcts_f_min, &
      ...
      REAL(rprec), DIMENSION(ndatafmax) ::  am_f_max, ac_f_max, &
                                            ...
                                            ne_f_max, te_f_max, &
                                            ti_f_max, th_f_max, &
                                            zeff_f_max,  emis_xics_f_max, emis_xmcts_f_max,&
      ...
      CHARACTER(256)  ::  equil_type, te_type, ne_type, ti_type, th_type, &
                          beamj_type, bootj_type, zeff_type, emis_xics_type, emis_xmcts_type,&
                          fixedcoilname, &
      ...
      INTEGER, PARAMETER ::  iemis_xmcts_f = 532
      ...
      SELECT CASE(var_num)
         ...
         CASE(iemis_xmcts_f)
            IF (var_dex2 == norm_dex) THEN
               WRITE(iunit,out_format) 'EMIS_xmcts_F:  xmcts Emissivity Profile Coef (normalization)'
            ELSE
               WRITE(iunit,out_format_1D) 'EMIS_xmcts_F(',var_dex1,'):  xmcts Emissivity Profile Coef'
            END IF
         CASE(iai_aux_s)
