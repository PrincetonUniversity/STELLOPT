...
rewrite the variation in potential energy:
    ...
    \text{Here, the MHD force components are }$\left(F_1,F_2,F_3\right)=\left(F_R,F_\phi,F_Z\right)$.
    \begin{array}{rcl}
...
\`F\' then \`MGRID\_FILE\' is ignored and may be omitted. The \`DELT\'
...
\'wout\' file can be found in \'LIB\_OPT/vsource/readw\_only\_priv.f.\'
If \'LDIAGNO\' was set to true in the input namelist, a \'diagno\_in\'
