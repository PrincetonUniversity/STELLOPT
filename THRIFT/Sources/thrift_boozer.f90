!-----------------------------------------------------------------------
!     Subroutine:    thrift_boozer
!     Authors:       S. Lazerson
!     Date:          11/01/2022
!     Description:   This subroutine handles conversion to boozer
!                    coordinates.
!-----------------------------------------------------------------------
      SUBROUTINE thrift_boozer(lscreen,iflag)
!-----------------------------------------------------------------------
!     Libraries
!-----------------------------------------------------------------------
      USE thrift_runtime
...
!----------------------------------------------------------------------
      ...
      IF (lvmec) THEN
         ...
         IF (ierr_mpi /= MPI_SUCCESS) CALL handle_err(MPI_ERR,'thrift_boozer: BARRIER1',ierr_mpi)
