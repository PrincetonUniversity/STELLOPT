...
MODULE thrift_vars
    ...
    INTEGER :: ntimesteps, nrho, nssize,  npicard, &
             ...
             win_thrift_bav,     win_thrift_bsqav,    win_thrift_s11,   &
             win_thrift_aminor,  win_thrift_rmajor,  &
    ...
    REAL(rprec), DIMENSION(:,:), POINTER :: THRIFT_ETAPARA, THRIFT_PPRIME, THRIFT_PHIEDGE, &
                 ...
                 THRIFT_BSQAV,   THRIFT_BAV,     THRIFT_S11,     THRIFT_VP,      &
