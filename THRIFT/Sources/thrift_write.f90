...
!----------------------------------------------------------------------
      IF (myworkid == master) THEN
         ...
         CALL write_var_hdf5(fid,'THRIFT_RHOINS',nrho,ier,DBLVAR=THRIFT_RHOINS,ATT='Rho grid translated to s',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_RHOINS',ier)
         CALL write_var_hdf5(fid,'THRIFT_SINRHO',nssize,ier,DBLVAR=THRIFT_SINRHO,ATT='S grid translated to rho',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_SINRHO',ier)
         ! 2D Floats
         ! Current densities
         nfg = nrho+2
         CALL write_var_hdf5(fid,'THRIFT_J',     nrho,ntimesteps,ier,DBLVAR=THRIFT_J,ATT='Total Current Density [A/m^2] (rho-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_J',ier)
         CALL write_var_hdf5(fid,'THRIFT_JBOOT', nrho,ntimesteps,ier,DBLVAR=THRIFT_JBOOT,ATT='Bootstrap Current Density [A/m^2] (rho-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_JBOOT',ier)
         CALL write_var_hdf5(fid,'THRIFT_JECCD', nrho,ntimesteps,ier,DBLVAR=THRIFT_JECCD,ATT='ECCD Current Density [A/m^2] (rho-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_JECCD',ier)
         CALL write_var_hdf5(fid,'THRIFT_JNBCD', nrho,ntimesteps,ier,DBLVAR=THRIFT_JNBCD,ATT='NBCD Current Density [A/m^2] (rho-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_JNBCD',ier)
         CALL write_var_hdf5(fid,'THRIFT_JOHMIC',nrho,ntimesteps,ier,DBLVAR=THRIFT_JOHMIC,ATT='Ohmic Current Density [A/m^2] (rho-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_JOHMIC',ier)
         CALL write_var_hdf5(fid,'THRIFT_JPLASMA',nrho,ntimesteps,ier,DBLVAR=THRIFT_JPLASMA,ATT='Plasma Response Current Density [A/m^2] (rho-space)',ATT_NAME='description')
         ...
         ! Currents
         CALL write_var_hdf5(fid,'THRIFT_UGRID',nssize,ntimesteps,ier,DBLVAR=THRIFT_UGRID,ATT='U (s-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_UGRID',ier)
         CALL write_var_hdf5(fid,'THRIFT_I',nssize,ntimesteps,ier,DBLVAR=THRIFT_I,ATT='Enclosed Total Current [A] (s-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_I',ier)
         CALL write_var_hdf5(fid,'THRIFT_IBOOT',nssize,ntimesteps,ier,DBLVAR=THRIFT_IBOOT,ATT='Enclosed Bootstrap Current [A] (s-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_IBOOT',ier)
         CALL write_var_hdf5(fid,'THRIFT_IECCD',nssize,ntimesteps,ier,DBLVAR=THRIFT_IECCD,ATT='Enclosed ECCD Current [A] (s-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_IECCD',ier)
         CALL write_var_hdf5(fid,'THRIFT_INBCD',nssize,ntimesteps,ier,DBLVAR=THRIFT_INBCD,ATT='Enclosed NBCD Current [A] (s-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_INBCD',ier)
         CALL write_var_hdf5(fid,'THRIFT_IOHMIC',nssize,ntimesteps,ier,DBLVAR=THRIFT_IOHMIC,ATT='Enclosed Ohmic Current [A] (s-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_IOHMIC',ier)
         CALL write_var_hdf5(fid,'THRIFT_IPLASMA',nssize,ntimesteps,ier,DBLVAR=THRIFT_IPLASMA,ATT='Enclosed Plasma Response Current [A] (s-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_IPLASMA',ier)
         CALL write_var_hdf5(fid,'THRIFT_ISOURCE',nssize,ntimesteps,ier,DBLVAR=THRIFT_ISOURCE,ATT='Enclosed Source Current [A] (s-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_ISOURCE',ier)
         ! Profile variables
         CALL write_var_hdf5(fid,'THRIFT_ETAPARA',nssize,ntimesteps,ier,DBLVAR=THRIFT_ETAPARA,ATT=' Parallel electric resistivity (s-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_ETAPARA',ier)
         CALL write_var_hdf5(fid,'THRIFT_PPRIME',nssize,ntimesteps,ier,DBLVAR=THRIFT_PPRIME,ATT=' Radial derivative of pressure (s-space)',ATT_NAME='description')
         ...
         CALL write_var_hdf5(fid,'THRIFT_VP',nssize,ntimesteps,ier,DBLVAR=THRIFT_VP,ATT='dV/dPhi (s-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_VP',ier)
         CALL write_var_hdf5(fid,'THRIFT_S11',nssize,ntimesteps,ier,DBLVAR=THRIFT_S11,ATT='Susceptance matrix element S11 (s-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_S11',ier)
         CALL write_var_hdf5(fid,'THRIFT_BAV',nssize,ntimesteps,ier,DBLVAR=THRIFT_BAV,ATT='<B> [T] (s-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_BAV',ier)
         CALL write_var_hdf5(fid,'THRIFT_BSQAV',nssize,ntimesteps,ier,DBLVAR=THRIFT_BSQAV,ATT='<B^2> [T^2] (s-space) ',ATT_NAME='description')
         ...
         CALL write_var_hdf5(fid,'THRIFT_COEFF_B',nssize,ntimesteps,ier,DBLVAR=THRIFT_COEFF_B,ATT='Coefficient B (s-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_COEFF_B',ier)
         CALL write_var_hdf5(fid,'THRIFT_COEFF_C',nssize,ntimesteps,ier,DBLVAR=THRIFT_COEFF_C,ATT='Coefficient C (s-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_COEFF_C',ier)
         CALL write_var_hdf5(fid,'THRIFT_COEFF_D',nssize,ntimesteps,ier,DBLVAR=THRIFT_COEFF_D,ATT='Coefficient D (s-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_COEFF_D',ier)
         CALL write_var_hdf5(fid,'THRIFT_COEFF_BP',nssize,ntimesteps,ier,DBLVAR=THRIFT_COEFF_BP,ATT='Derivative of coefficient B (s-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_COEFF_BP',ier)
         CALL write_var_hdf5(fid,'THRIFT_COEFF_CP',nssize,ntimesteps,ier,DBLVAR=THRIFT_COEFF_CP,ATT='Derivative of coefficient C (s-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_COEFF_CP',ier)
         CALL write_var_hdf5(fid,'THRIFT_COEFF_DP',nssize,ntimesteps,ier,DBLVAR=THRIFT_COEFF_DP,ATT='Derivative of coefficient D (s-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_COEFF_DP',ier)
         ! Alphas
         CALL write_var_hdf5(fid,'THRIFT_ALPHA1',nssize-2,ntimesteps,ier,DBLVAR=THRIFT_ALPHA1,ATT='Coefficient alpha_1 (s-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_ALPHA1',ier)
         CALL write_var_hdf5(fid,'THRIFT_ALPHA2',nssize-2,ntimesteps,ier,DBLVAR=THRIFT_ALPHA2,ATT='Coefficient alpha_2 (s-space)',ATT_NAME='description')
         IF (ier /= 0) CALL handle_err(HDF5_WRITE_ERR,'THRIFT_ALPHA2',ier)
         CALL write_var_hdf5(fid,'THRIFT_ALPHA3',nssize-2,ntimesteps,ier,DBLVAR=THRIFT_ALPHA3,ATT='Coefficient alpha_3 (s-space)',ATT_NAME='description')
