...
!----------------------------------------------------------------------
      ...
      CALL mpialloc(THRIFT_A,        nrho, ntimesteps, myid_sharmem, 0, MPI_COMM_SHARMEM, win_thrift_a)
      CALL mpialloc(THRIFT_B,        nrho, ntimesteps, myid_sharmem, 0, MPI_COMM_SHARMEM, win_thrift_b)
      CALL mpialloc(THRIFT_C,        nrho, ntimesteps, myid_sharmem, 0, MPI_COMM_SHARMEM, win_thrift_c)
      CALL mpialloc(THRIFT_D,        nrho, ntimesteps, myid_sharmem, 0, MPI_COMM_SHARMEM, win_thrift_d)
