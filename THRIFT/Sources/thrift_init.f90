...
!----------------------------------------------------------------------
      ...
      CALL mpialloc(THRIFT_A,      nrho+2, ntimesteps, myid_sharmem, 0, MPI_COMM_SHARMEM, win_thrift_a)
      CALL mpialloc(THRIFT_B,      nrho+2, ntimesteps, myid_sharmem, 0, MPI_COMM_SHARMEM, win_thrift_b)
      CALL mpialloc(THRIFT_C,      nrho+2, ntimesteps, myid_sharmem, 0, MPI_COMM_SHARMEM, win_thrift_c)
      CALL mpialloc(THRIFT_D,      nrho+2, ntimesteps, myid_sharmem, 0, MPI_COMM_SHARMEM, win_thrift_d)
