...
!----------------------------------------------------------------------
      IMPLICIT NONE
      LOGICAL         :: lverb, lwout, lasym, lfreeb, lmake_coils,lbrho
      INTEGER         :: iter, nextcur, extsurfs, lastsurf, vsurf
      INTEGER         :: m_new, n_new, free_override, mustochf
      CHARACTER(256)  :: id_string, mgrid_file, coils_file
      ...
      REAL(rprec), PARAMETER :: VMEC2PIES_VERSION = 2.0
!-----------------------------------------------------------------------
!     Subroutines
